...
namespace xadrez
{
    class PartidaXadrez
    {
        ...
        public void colocarPecas()
        {
            ...
            tabuleiro.colocarPeca(new Dama(tabuleiro, Cor.Branca), new PosicaoXadrez('e', 8).toPosicao());
            ...
            tabuleiro.colocarPeca(new Dama(tabuleiro, Cor.Preta), new PosicaoXadrez('e', 1).toPosicao());
